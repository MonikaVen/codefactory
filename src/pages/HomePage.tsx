  ...
  return (
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <p className="lead">
          Skyriai, ženklai, kortelės ir Regitros stiliaus egzaminas — pagal aktualią 2026-01-01 redakciją.
        </p>
      ...
      <div className="mode-grid" style={{ width: 'min(1120px, 100%)', marginInline: 'auto' }}>
